    ...
    <div>
      <Container>
        ...
        <div id="soc-med-container">
          ...
          {ArrowDown(<a href='https://twitter.com/1nathan_liang' target='_blank' rel='noreferrer nofollow' className='soc-med' id='mastodon'><FontAwesomeIcon icon={['fab', 'mastodon']} size="2x" /></a>, "Mastodon")}
