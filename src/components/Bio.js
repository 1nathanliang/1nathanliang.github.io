    ...
    <div>
      <Container>
        ...
        <div id="soc-med-container">
          ...
          {ArrowDown(<a href='https://vis.social/@1nathan_liang' target='_blank' rel='me' className='soc-med' id='mastodon'><FontAwesomeIcon icon={['fab', 'mastodon']} size="2x" /></a>, "Mastodon")}
